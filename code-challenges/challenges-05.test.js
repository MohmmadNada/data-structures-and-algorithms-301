...
const sortStarWarsCharacters = (starWarsArr) => {
    // Solution code here... ///remember return 
...
const joinArray = (arr) => {
    // Solution code here...
    return arr.join(' '); //join not joint
...
const listFoods = (recipe) => {
    ...
    recipe.ingredients.forEach(element => {
        let elementAfterIdet = element.split(' ')
        elementAfterIdet = elementAfterIdet.slice(2)
        elementAfterIdet = elementAfterIdet.join(' ')

        // console.log(elementAfterIdet)

        // elementAfterIdet=elementAfterIdet.splice(1)

        result.push(elementAfterIdet)
